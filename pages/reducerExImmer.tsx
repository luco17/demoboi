...
import { locationReducer } from "../reducers/itineraryReducerImmer";
...
export default function TaskApp() {
  const [locations, dispatch] = useImmerReducer(locationReducer, places);
  ...
  return (
    <div className="grid h-screen bg-zinc-800 place-items-center">
      <div className="rounded bg-zinc-100 shadow-sm p-6 max-w-sm">
